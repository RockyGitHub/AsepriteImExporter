...
public class AsepriteExporter
{
    ...
    public void Setup(string pathToJson, string pathToAsepriteFile, string pathToOutputRoot)
    {
        PathToAsepriteExportJson = pathToJson;
        PathToAsepriteFile = pathToAsepriteFile;
        PathToOutputRoot = pathToOutputRoot;
